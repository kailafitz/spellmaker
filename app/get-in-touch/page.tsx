      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20">
        <div className="flex flex-col justify-between gap-y-10 md:gap-x-10">
          <div className="flex flex-col justify-between gap-y-10">
            <div>
              <h1 className="text-large uppercase font-medium">Get in Touch</h1>
        ...
        <div className="flex flex-col gap-y-5">
          ...
          <Textarea placeholder="Message" rows={100} maxLength={350} className="min-h-48" />
          <div>
            <Button label="Dispatch Spell" className="" />
          </div>
        </div>
      </div>
    </Container>
